...
function AxcendConceptPrototypeV3({
  contactDialogOpen,
  ...
  const visibleCases = Array.from({ length: 5 }, (_, offset) => {
  ...
  const meetings = Math.round((companies * conversion) / 100);
  const revenue = meetings * avgDeal;
  const featuredSlides = [heroSlides[0], heroSlides[1], heroSlides[2], heroSlides[5]];
  const activeWhat = whatWeDo[whatIndex];

  return (
    <div id="top" className="min-h-screen bg-[#f5f7f0] text-axcend-dark">
      <ContactChoiceDialog open={contactDialogOpen} onOpenChange={onContactDialogOpenChange} />

      <header className="sticky top-0 z-50 border-b border-axcend-dark/10 bg-[#f5f7f0]/88 backdrop-blur-xl">
        <nav className="mx-auto grid max-w-[1480px] grid-cols-[auto_1fr_auto] items-center gap-5 px-5 py-4 md:px-8">
          <a href="#top" className="text-base font-semibold tracking-tight">
            AXCEND
          </a>
          <div className="hidden justify-self-center text-sm text-muted-foreground md:block">
      ...
      <main>
        <section className="bg-axcend-dark text-white">
          <div className="mx-auto grid min-h-[calc(100vh-68px)] max-w-[1480px] gap-10 px-5 py-8 md:grid-cols-[minmax(0,0.94fr)_minmax(520px,1.06fr)] md:px-8 md:py-12">
            <div className="flex flex-col justify-between gap-12">
              <div className="pt-10 md:pt-16">
                <div className="mb-7 flex flex-wrap items-center gap-3 text-xs font-semibold uppercase tracking-[0.18em] text-white/55">
                  ...
                  <span className="h-px w-14 bg-axcend-action" />
                  <span>Центральная Азия</span>
                </div>
                <h1 className="max-w-4xl text-[46px] font-semibold leading-[0.93] tracking-tight md:text-[78px] xl:text-[96px]">
            ...
            <div className="grid min-h-[650px] gap-px bg-white/10 md:grid-cols-[1.12fr_0.88fr]">
              <div className="relative overflow-hidden bg-axcend-dark">
                <img
                  src={featuredSlides[0].src}
                  alt={featuredSlides[0].country}
                  className="h-full w-full object-cover"
                />
                <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-axcend-dark/78 via-axcend-dark/24 to-transparent p-5">
                  <span className="rounded-full bg-white/14 px-3 py-1 text-sm font-semibold backdrop-blur">
                    {featuredSlides[0].country}
                  </span>
                </div>
              </div>
              <div className="grid gap-px">
                {featuredSlides.slice(1).map((slide) => (
                  <div key={slide.country} className="relative overflow-hidden bg-axcend-dark">
                    <img
                      src={slide.src}
                      alt={slide.country}
                      className="h-full w-full object-cover"
        ...
        <section id="why" className="bg-[#f5f7f0]">
          <div className="mx-auto grid max-w-[1480px] gap-12 px-5 py-16 md:grid-cols-[0.78fr_1.22fr] md:px-8 md:py-24">
            <div className="md:sticky md:top-28 md:self-start">
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                Почему AXCEND
              </div>
              <div className="mt-8 bg-axcend-action px-6 py-8 md:px-8 md:py-10">
                <div className="text-[96px] font-semibold leading-none tracking-tight md:text-[152px]">
                  32%
                </div>
                <h2 className="mt-5 max-w-lg text-[34px] font-semibold leading-[1.02] tracking-tight md:text-[56px]">
            ...
            <div className="border-y border-axcend-dark/14">
              {conversionReasons.map((item, index) => (
                <article
                  key={item.title}
                  className="grid gap-6 border-b border-axcend-dark/14 py-8 last:border-b-0 md:grid-cols-[96px_minmax(0,1fr)]"
                >
                  <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                    0{index + 1}
                  </div>
        ...
        <section id="what" className="bg-white">
          <div className="mx-auto max-w-[1480px] px-5 py-16 md:px-8 md:py-24">
            <div className="grid gap-12 border-y border-axcend-dark/14 py-10 md:grid-cols-[0.68fr_1.32fr]">
              <div>
                <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                  Что вы получаете
                </div>
                <h2 className="mt-4 text-[40px] font-semibold leading-none tracking-tight md:text-[68px]">
                  Работая с AXCEND
                </h2>
              </div>
              <div>
                <div className="grid gap-px bg-axcend-dark/12 sm:grid-cols-2 lg:grid-cols-3">
                  {whatWeDo.map((item, index) => (
                    <button
                      ...
                      className={cn(
                        "bg-white px-4 py-4 text-left text-sm font-semibold leading-tight transition-colors",
                        whatIndex === index && "bg-axcend-action",
                      )}
                    >
                      {item.title}
                    </button>
                ...
                <article className="mt-8 border-l-[12px] border-axcend-action bg-[#f5f7f0] px-6 py-7 md:px-9 md:py-9">
        ...
        <section id="work" className="bg-axcend-dark text-white">
          <div className="mx-auto grid max-w-[1480px] gap-12 px-5 py-16 md:grid-cols-[0.72fr_1.28fr] md:px-8 md:py-24">
            <div>
              ...
              {launchStages.map((stage) => (
                <AccordionItem key={stage.number} value={stage.number} className="border-0">
                  <AccordionTrigger className="py-6 text-left hover:no-underline [&>svg]:text-axcend-action">
                    <span className="grid w-full gap-4 md:grid-cols-[92px_minmax(0,1fr)]">
        ...
        <section id="team" className="bg-[#f5f7f0]">
          <div className="mx-auto max-w-[1480px] px-5 py-16 md:px-8 md:py-24">
            <div className="mb-10 border-b border-axcend-dark/14 pb-8">
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                Команда
              </div>
              <h2 className="mt-4 text-[40px] font-semibold leading-none tracking-tight md:text-[68px]">
            ...
            <div className="grid gap-px bg-axcend-dark/14 md:grid-cols-4">
              {teamMembers.map((member) => (
                <article key={member.name} className="grid bg-[#f5f7f0]">
                  <div className="relative h-[460px] overflow-hidden bg-[#e8ece2] md:h-[620px]">
                    <img
                      src={member.image}
                      alt={member.name}
                      loading="lazy"
                  ...
                  <div className="grid min-h-[270px] grid-rows-[72px_78px_1fr] bg-white/70 p-5 md:p-6">
        ...
        <section id="industries" className="bg-white">
          <div className="mx-auto grid max-w-[1480px] gap-10 px-5 py-16 md:grid-cols-[0.66fr_1.34fr] md:px-8 md:py-24">
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                Отрасли и конверсии
              </div>
              ...
              <div className="grid gap-6 bg-axcend-action px-5 py-6 text-axcend-dark md:grid-cols-[1fr_auto] md:px-7">
                ...
                <div className="md:text-right">
                  ...
                  <div className="mt-1 text-xs font-semibold text-axcend-dark/62">
                    {fmt(activeCase.hits)} из {fmt(activeCase.total)} диалогов
                  </div>
                </div>
              </div>
              <div className="divide-y divide-axcend-dark/10">
                {visibleCases.map((item) => (
                  <button
                    ...
                    className={cn(
                      "grid w-full gap-4 px-5 py-4 text-left transition-colors md:grid-cols-[1fr_120px_180px] md:px-7",
                      item.index === caseIndex ? "bg-[#f5f7f0]" : "bg-white hover:bg-[#f5f7f0]",
                    )}
                  >
                    <span>
                    ...
                    <span className="text-sm text-muted-foreground">
                      {fmt(item.hits)} из {fmt(item.total)} диалогов
                    </span>
                  </button>
                ))}
              </div>
        ...
        <section id="proof" className="bg-[#f5f7f0]">
          <div className="mx-auto max-w-[1480px] px-5 py-16 md:px-8 md:py-24">
            <div className="grid gap-10 md:grid-cols-[0.68fr_1.32fr]">
              ...
              <div className="border-y border-axcend-dark/14">
                {proofs.map((item, index) => (
                  <article
                    key={item.title}
                    className="grid gap-6 border-b border-axcend-dark/14 py-7 last:border-b-0 md:grid-cols-[96px_minmax(0,1fr)]"
                  >
                    <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                      0{index + 1}
                    </div>
        ...
        <section id="guarantee" className="bg-axcend-dark text-white">
          <div className="mx-auto grid max-w-[1480px] gap-8 px-5 py-16 md:grid-cols-[0.72fr_1.28fr] md:px-8 md:py-24">
            <div className="text-xs font-semibold uppercase tracking-[0.18em] text-axcend-action">
              Гарантия
            </div>
            <div>
              <h2 className="max-w-4xl text-[38px] font-semibold leading-tight tracking-tight md:text-[64px]">
                Гарантия от 5% конверсии в договоре
              </h2>
              <p className="mt-7 max-w-4xl text-base leading-relaxed text-white/68 md:text-xl">
                Не менее 5% обработанной базы переходят в прямое обсуждение сделки с заказчиком.
                Если заявленные 5% не достигнуты, мы запускаем проект повторно за свой счёт и
                работаем до тех пор, пока не выйдем на зафиксированный в договоре результат.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="calc" className="bg-white">
          <div className="mx-auto grid max-w-[1480px] gap-10 px-5 py-16 md:grid-cols-[0.68fr_1.32fr] md:px-8 md:py-24">
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
            ...
            <div className="grid border-y border-axcend-dark/14 lg:grid-cols-[minmax(0,1fr)_360px]">
              <div className="divide-y divide-axcend-dark/12 lg:border-r lg:border-axcend-dark/14">
                {[
                  {
                    label: "Размер базы целевых компаний",
                    value: companies,
                  ...
                  <div
                    key={item.label}
                    className="grid gap-4 px-5 py-5 md:grid-cols-[1fr_170px] md:px-7"
                  >
                    <div>
                      ...
                      <Slider
                        ...
                        step={item.step}
                        value={[item.value]}
                        onValueChange={([next]) => item.setter(next)}
                        className="mt-5"
                      />
                    </div>
                    <div className="flex items-center justify-start text-2xl font-semibold tabular-nums md:justify-end">
                      {fmt(item.value)}
                      {item.suffix}
                    </div>
                  </div>
              ...
              <div className="grid bg-axcend-action p-6 text-axcend-dark md:p-7">
                <div>
                  <div className="text-xs font-semibold uppercase tracking-[0.18em] text-axcend-dark/60">
                    Минимум
                  </div>
                  ...
                  <div className="mt-2 text-sm font-semibold">5% в договоре</div>
                </div>
                <div className="mt-8 border-t border-axcend-dark/18 pt-6">
                  <div className="text-xs font-semibold uppercase tracking-[0.18em] text-axcend-dark/60">
                    Конверсия
                  </div>
                  <div className="mt-2 text-4xl font-semibold tabular-nums">{meetings}</div>
                </div>
                <div className="mt-8 border-t border-axcend-dark/18 pt-6">
                  <div className="text-xs font-semibold uppercase tracking-[0.18em] text-axcend-dark/60">
                    Выручка
                  </div>
                  <div className="mt-2 text-4xl font-semibold tabular-nums">${fmt(revenue)}</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <section id="faq" className="bg-[#f5f7f0]">
          <div className="mx-auto grid max-w-[1480px] gap-10 px-5 py-16 md:grid-cols-[0.68fr_1.32fr] md:px-8 md:py-24">
            <div>
              <div className="text-xs font-semibold uppercase tracking-[0.18em] text-muted-foreground">
                FAQ
            ...
            <Accordion
              type="single"
              collapsible
              className="divide-y divide-axcend-dark/14 border-y border-axcend-dark/14"
            >
              {faqs.map((item, index) => (
                <AccordionItem key={item.q} value={String(index)} className="border-0">
                  <AccordionTrigger className="py-5 text-left text-base font-semibold hover:no-underline [&>svg]:text-axcend-dark">
                    {item.q}
                  </AccordionTrigger>
        ...
        <section id="contact" className="bg-axcend-dark text-white">
          <div className="mx-auto grid max-w-[1480px] gap-10 px-5 py-16 md:grid-cols-[1fr_0.74fr] md:px-8 md:py-24">
            <div>
...
function Index() {
  ...
  const [conceptPrototype, setConceptPrototype] = useState<"" | "1" | "2" | "3">("");

  useEffect(() => {
    const value = new URLSearchParams(window.location.search).get("concept-2026");
    setConceptPrototype(value === "3" ? "3" : value === "2" ? "2" : value !== null ? "1" : "");
  }, []);
  ...
  if (conceptPrototype === "3") {
    return (
      <AxcendConceptPrototypeV3
